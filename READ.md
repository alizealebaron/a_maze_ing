...
Afin de faciliter l'utilisation de notre programme a_maze_ing, un Makefil vous est fourni et comprend un certains nombre de commande utile pour installer le projet :
